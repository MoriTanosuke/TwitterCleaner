...
public class DeleteStatusWorker extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			AccessToken accessToken = OAuthAccessTokenSerializer.deserializeOAuthAccessToken(req.getParameter("oauthtoken").getBytes());
			log.finest("Trying to destroy status '" + id + "' with access token for username '" + accessToken.getScreenName() + "'");
